...
import com.udi.gaaf.transaccion_inventario.DatosDetalleTransaccion;
...
public class TransaccionController {
	...
	@PostMapping("/crear")
	public ResponseEntity<DatosDetalleTransaccion> crear(@RequestBody(required = false) @Valid DatosRegistrarTransaccion datos) {
		if(datos == null) {
